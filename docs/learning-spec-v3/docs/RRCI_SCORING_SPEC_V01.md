# RRCI scoring specification V0.1
...
| irradiation/exposure is assumed to make matter/person radioactive | E08, E10; Scientist nuance S13 |
...
## 6. Scientific-questioning outcome — gameplay process only

Do not include G01/G02 in the RRCI conceptual pre/post score. Scientific-questioning is a process outcome of the game. Derive it primarily from actual gameplay:
...
- ScientistActivation/RiskContext: S13 (report separately until enough calibrated items exist)
